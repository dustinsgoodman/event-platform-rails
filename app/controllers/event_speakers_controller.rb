class EventSpeakersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @event_speaker.save
        format.html { redirect_to event_speaker_url(@event_speaker), notice: "Event speaker was successfully created." }
  ...
  def update
    respond_to do |format|
      if @event_speaker.update(event_speaker_params)
        format.html { redirect_to event_speaker_url(@event_speaker), notice: "Event speaker was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to event_speakers_url, notice: "Event speaker was successfully destroyed." }
  ...
  private
    ...
    def event_speaker_params
      params.require(:event_speaker).permit(:first_name, :last_name, :job_title, :company, :profile_picture, :bio, :date_of_birth, :language, :ip_address)
    end
end
